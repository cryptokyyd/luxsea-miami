...
BOATS = [
{
 ...
 "faqs_en": [
   ...
   ("Does it have a real bathroom?","Yes — a head with a shower, plus a fitted cabin to change in. It is the only one of the three boats with both."),
 ...
 "faqs_es": [
   ...
   ("¿Tiene baño de verdad?","Sí — baño con ducha, más un camarote equipado para cambiarse. Es el único de los tres botes que tiene los dos."),
...
},
{
 ...
 "hero": "amberjack-32.jpg",
 "hero_alt_en": "The Sea Ray Amberjack 32 anchored by itself in deep green water with the bimini up",
 "hero_alt_es": "El Sea Ray Amberjack 32 anclado solo en agua verde profunda con el bimini puesto",
 "specs_en": [("Length","32 ft"),("Hours","4 · 5 · 6"),("Best for","Small groups"),("Layout","Open cockpit"),("Shade","Bimini"),("Speciality","The sandbar")],
 "specs_es": [("Largo","32 pies"),("Horas","4 · 5 · 6"),("Mejor para","Grupos chicos"),("Cubierta","Bañera abierta"),("Sombra","Bimini"),("Especialidad","El banco de arena")],
 "body_en": [
   ...
   ("What it is not",
    ["It is not the boat for a thirteen-person bachelorette, and we will tell you that rather than take the booking. There is no shower and no fitted cabin; the shade is a bimini, not a hardtop.",
   ...
   ("What it comes with",
    ["Captain and fuel, cooler on ice, drinking water, speaker, floating pool mat and life jackets in every size — the same standard kit as the other two boats.",
     "Only one of our posts features this boat on its own, so the gallery here is short. Everything you see is that day."]),
 ],
 "body_es": [
   ...
   ("Lo que no es",
    ["No es el bote para una despedida de trece personas, y te lo decimos en vez de tomar la reserva. No hay ducha ni camarote equipado; la sombra es un bimini, no un hardtop.",
   ...
   ("Qué trae",
    ["Capitán y gasolina, nevera con hielo, agua, bocina, piscina flotante y chalecos de todas las tallas — el mismo equipo de serie que los otros dos botes.",
     "Solo una de nuestras publicaciones muestra este bote solo, así que la galería aquí es corta. Todo lo que ves es de ese día."]),
 ],
 "gallery": [
   ("amberjack-32.jpg","The Amberjack 32 anchored alone, coral bow cushions and bimini up","El Amberjack 32 fondeado solo, cojines coral y bimini puesto"),
   ("amberjack-32b.jpg","Closer aerial of the open cockpit and the anchor line","Vista aérea más cerca de la bañera abierta y la línea del ancla"),
 ],
 "faqs_en": [
   ...
   ("Does it have a bathroom?","No head with a shower like the Chris Craft 45. If a bathroom matters for your day, book the 45 instead — we would rather tell you now."),
 ...
 "faqs_es": [
   ...
   ("¿Tiene baño?","No tiene baño con ducha como el Chris Craft 45. Si el baño importa para tu día, reserva el 45 — preferimos decírtelo ahora."),
